...
-- UI Elements
hi("Visual",       { fg = "#1e2030", bg = "#ffffff" })
hi("VisualNOS",    { fg = "#1e2030", bg = "#ffffff" })
hi("Search",       { fg = "#1e2030", bg = "#f6d13a" })
hi("IncSearch",    { fg = "#1e2030", bg = "#60e1e0" })
hi("MatchParen",   { fg = "#f6d13a", bg = "NONE",    bold = true })
hi("StatusLine",   { fg = "#e1e3e7", bg = "#2d3043" })
hi("StatusLineNC", { fg = "#404552", bg = "#1e2030" })
hi("VertSplit",    { fg = "#404552", bg = "NONE" })
hi("WinSeparator", { fg = "#404552", bg = "NONE" })
hi("Pmenu",        { fg = "#e1e3e7", bg = "#2d3043" })
hi("PmenuSel",     { fg = "#1e2030", bg = "#dab6fc" })
hi("PmenuSbar",    { bg = "#404552" })
hi("PmenuThumb",   { bg = "#dab6fc" })
hi("WildMenu",     { fg = "#1e2030", bg = "#f6d13a" })
hi("ColorColumn",  { bg = "#2d3043" })
hi("EndOfBuffer",  { fg = "#404552", bg = "NONE" })
hi("NonText",      { fg = "#404552", bg = "NONE" })
hi("Folded",       { fg = "#60e1e0", bg = "#2d3043" })
